...
public class DeepLinkHelper {
     ...
     * @param callback
     */
    public void openOtherProfile( Activity activity, String memberId, DeepLinkListener callback) {
    ...
    private void deepLinkToProfile( Activity activity, String memberId,  AccessToken accessToken) {

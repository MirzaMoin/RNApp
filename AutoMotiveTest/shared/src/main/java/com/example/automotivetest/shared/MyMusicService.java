package com.example.automotivetest.shared;
...
public class MyMusicService extends MediaBrowserServiceCompat {
    ...
    @Override
    public BrowserRoot onGetRoot(l String clientPackageName,
                                 int clientUid,
                                 Bundle rootHints) {
    ...
    @Override
    public void onLoadChildren(l final String parentMediaId,
                               l final Result<List<MediaItem>> result) {
